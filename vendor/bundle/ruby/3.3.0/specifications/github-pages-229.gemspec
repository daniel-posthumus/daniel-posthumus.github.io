# -*- encoding: utf-8 -*-
# stub: github-pages 229 ruby lib

Gem::Specification.new do |s|
  s.name = "github-pages".freeze
  s.version = "229".freeze
  ...
  s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.9.4".freeze])
  ...
  s.add_runtime_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.4.0".freeze])
  ...
  s.add_runtime_dependency(%q<jekyll-relative-links>.freeze, ["= 0.7.0".freeze])
  ...
  s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.13.6".freeze, "< 2.0".freeze])
